---
name: trigger-ref
description: Full Trigger.dev SDK v4 code reference. Use when building Trigger.dev tasks, looking up API patterns, scheduling syntax, triggerAndWait, batch triggers, waits, debounce, or schema tasks.
